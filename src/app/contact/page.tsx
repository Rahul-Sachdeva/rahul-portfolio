...
const Contact = () => {
  ...
  return (
    <div className="z-20 bg-black mx-auto flex flex-col md:flex-row items-center justify-between p-8 text-white">
      {/* Left Section: Contact Form */}
      <div className="md:w-1/2 space-y-6 p-6 bg-[#151030] rounded-lg shadow-lg">
      ...
      <div className="md:w-1/2 flex flex-col items-center">
        {/* 3D Earth */}
        <div className="w-[500px] h-[500px] md:w-[500px] md:h-[500px]">
        ...
        <button 
          ...
          className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white p-3 rounded-lg"
        >
          <FaLocationDot />
